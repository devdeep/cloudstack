...
public class MigrateWithStorageGetDestPathsCommand extends Command {
    List<Pair<VolumeTO, StorageFilerTO>> volumeToFilerAsList;

    public MigrateWithStorageGetDestPathsCommand(List<Pair<VolumeTO, StorageFilerTO>> volumeToFilerAsList) {
