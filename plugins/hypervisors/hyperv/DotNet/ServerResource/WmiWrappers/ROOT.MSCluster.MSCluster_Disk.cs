namespace CloudStack.Plugin.WmiWrappers.ROOT.MSCLUSTER {
    ...
    // An Early Bound class generated for the WMI class.MSCluster_Disk
    public class Disk : System.ComponentModel.Component {
        ...
        private static string CreatedClassName = "MSCluster_Disk";
        ...
        public Disk(string keyId) {
            this.InitializeObject(null, new System.Management.ManagementPath(Disk.ConstructPath(keyId)), null);
        }
        
        public Disk(System.Management.ManagementScope mgmtScope, string keyId) {
            this.InitializeObject(((System.Management.ManagementScope)(mgmtScope)), new System.Management.ManagementPath(Disk.ConstructPath(keyId)), null);
        }
        ...
        private static string ConstructPath(string keyId) {
            string strPath = "ROOT\\MSCluster:MSCluster_Disk";
        ...
        public static DiskCollection GetInstances(System.Management.ManagementScope mgmtScope, System.Management.EnumerationOptions enumOptions) {
            ...
            pathObj.ClassName = "MSCluster_Disk";
        ...
        public static DiskCollection GetInstances(System.Management.ManagementScope mgmtScope, string condition, string[] selectedProperties) {
            ...
            System.Management.ManagementObjectSearcher ObjectSearcher = new System.Management.ManagementObjectSearcher(mgmtScope, new SelectQuery("MSCluster_Disk", condition, selectedProperties));
